...
def test_validation_and_error_reporting():
    """Test file ingestion, validation, and error reporting."""
    print("=" * 70)
...
"""
    ...
    if response.status_code == 200:
        ...
        print(f"      By severity: ERROR={summary.get('error_count', 0)}, "
              f"WARNING={summary.get('warning_count', 0)}, INFO={summary.get('info_count', 0)}")
