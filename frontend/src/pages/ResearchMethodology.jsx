...
import { Target, Search, MapPin, Lightbulb, Ruler, Star, Link, AlertTriangle, Hash, Globe, Wrench, Shield, Sparkles, BarChart, Rocket, Dna } from 'lucide-react';
...
const ResearchMethodology = () => {
    ...
    return (
        <div className="research-methodology-page-container">
            <Sidebar activeTab="methodology" />
            <div className="research-methodology-content-wrapper">
                <div className="research-methodology-page">
                    ...
                    <header className="research-header">
                        <div className="header-content">
                            ...
                            >
                                <Dna size={40} className="inline-icon" /> Research Methodology
                            </motion.h1>
                    ...
                    <div className="methodology-content">
                        ...
                        >
                            <h2><Target size={28} className="inline-icon" /> Why Machine Learning for Astronomy?</h2>
                        ...
                        >
                            <h2><Search size={28} className="inline-icon" /> Anomaly Detection: Finding the Unusual</h2>
                            <div className="section-content">
                                ...
                                <div className="features-grid">
                                    <div className="feature-card">
                                        <span className="feature-icon"><MapPin size={32} /></span>
                                    ...
                                    <div className="feature-card">
                                        <span className="feature-icon"><Lightbulb size={32} /></span>
                                        <strong>Brightness (Magnitude)</strong>
                                        <p>Distance-corrected when possible</p>
                                    </div>
                                    <div className="feature-card">
                                        <span className="feature-icon"><Ruler size={32} /></span>
                                ...
                                <div className="info-box">
                                    <h4><Star size={20} className="inline-icon" /> Research Enhancement</h4>
                                    <p>
                        ...
                        >
                            <h2><Link size={28} className="inline-icon" /> Spatial Clustering: Finding Groups</h2>
                            <div className="section-content">
                        ...
                        >
                            <h2><AlertTriangle size={28} className="inline-icon" /> Known Limitations</h2>
                            <div className="section-content">
                                <p>
                                ...
                                <div className="limitations-grid">
                                    <div className="limitation-card">
                                        <h4><Hash size={20} className="inline-icon" /> Data Dependency</h4>
                                        <p>
                                    ...
                                    <div className="limitation-card">
                                        <h4><Target size={20} className="inline-icon" /> Statistical Nature</h4>
                                        <p>
                                    ...
                                    <div className="limitation-card">
                                        <h4><Globe size={20} className="inline-icon" /> 2D Projections</h4>
                                        <p>
                                    ...
                                    <div className="limitation-card">
                                        <h4><Wrench size={20} className="inline-icon" /> Parameter Sensitivity</h4>
                                        <p>
                                ...
                                <div className="honesty-box">
                                    <h4><Shield size={20} className="inline-icon" /> Our Commitment to Transparency</h4>
                                    <p>
                        ...
                        >
                            <h2><Sparkles size={28} className="inline-icon" /> Real Discoveries from COSMIC Data</h2>
                            <div className="section-content">
                                <p>
                                ...
                                <div className="discoveries-grid">
                                    <div className="discovery-card">
                                        <h4><BarChart size={20} className="inline-icon" /> 459 Cross-Matched Pairs</h4>
                                        <p>
                                    ...
                                    <div className="discovery-card">
                                        <h4><Star size={20} className="inline-icon" /> 50 Anomalous Objects</h4>
                                        <p>
                                    ...
                                    <div className="discovery-card">
                                        <h4><Link size={20} className="inline-icon" /> 8 Stellar Clusters</h4>
                                        <p>
                        ...
                        >
                            <h2><Rocket size={28} className="inline-icon" /> Best Practices for Researchers</h2>
                            <div className="section-content">
