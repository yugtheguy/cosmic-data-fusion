...
import { Sparkles, TrendingUp, AlertCircle, Info, Lightbulb, Brain, BarChart2 } from 'lucide-react';
...
const AIResearchAssistant = () => {
  ...
  return (
    <div className="ai-research-assistant-page-container">
      <Sidebar activeTab="ai-assistant" />
      <div className="ai-research-assistant-content-wrapper">
          ...
          <div className="ai-toggle-container">
            <label className="ai-toggle">
              ...
              <span className="toggle-label">
                {aiEnabled ? (
                  <><Brain size={16} /> AI Analysis Enabled</>
                ) : (
                  <><BarChart2 size={16} /> Standard Query Mode</>
                )}
              </span>
            </label>
            {aiEnabled && (
